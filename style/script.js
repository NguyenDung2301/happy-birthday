  ...
  btn.addEventListener("click", () => {
    ...
    if (selected === correctAge) {
      ...
      agePopup.innerHTML = `
        ...
        <p>Cho bà chọn lại 1 lần nữa đó!!!</p>
        <button class="close-btn" onclick="location.reload()">Đoán lại cho tui 🫤</button>
      `;
    }
  });
});
...
const musicBtn = document.getElementById("music-btn");
  ...
  const messages = [
    "Sinh nhật zui zẻ nha bà, quý lắm mới chúc á nha bà:))) 💝🎂.",
    ...
    "Thêm một tuổi mới, chúc sao cho bà luôn zui zẻ bên bạn bè, gia đình và người bà luôn yêu thương 🤗💞.",
    "Hãy tận hưởng ngày đặc biệt này với thật nhiều niềm vui và tiếng cười nhé! ❤️🎈",
    "20 tuổi rồi bớt thức khuya chơi liên quân lại nha, chơi cùng tôi thì được hihi:)))🥳."
  ];
